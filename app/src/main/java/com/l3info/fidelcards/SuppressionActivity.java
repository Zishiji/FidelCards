...
public class SuppressionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listViewCard.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int pos, long id) {
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "Voulez vous supprimer la carte "+obj, Toast.LENGTH_SHORT);
                toast.show();
                String carte = obj.toString();
    ...
    public void affichage_carte() {
        ...
        /*if (c.moveToFirst()) {
            ...
            num = String.valueOf(c.getInt(c.getColumnIndex(FeedEntry.COLUMN_CARD_NUM)));
